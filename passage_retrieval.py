...
try:
    ...
    print(e)
    print(r"Download the code from https://github.com/facebookresearch/contriever")
...
class Retriever:
    ...
    def add_passages(self, passages, top_passages_and_scores):
        ...
        res = []
        for passages_scores in top_passages_and_scores:
            doc_ids = passages_scores[0]
            scores = passages_scores[1]
            docs = [{**passages[doc_id], "score": score} for doc_id, score in zip(doc_ids, scores)]
            res.append(docs)
        return res
    ...
    def search_document(self, query, top_n=10):
        ...
        return self.add_passages(self.passage_id_map, top_ids_and_scores)
